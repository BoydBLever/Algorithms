// https://leetcode.com/problems/all-paths-from-source-to-target/solutions/3183523/optimized-solution-to-all-paths-from-source-to-target-problem-in-javascript/
/**
 * @param {number[][]} graph
 * @return {number[][]}
 */
